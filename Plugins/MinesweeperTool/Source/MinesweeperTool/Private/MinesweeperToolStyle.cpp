...
TSharedPtr< FSlateStyleSet > FMinesweeperToolStyle::StyleInstance = NULL;
...
TSharedRef< FSlateStyleSet > FMinesweeperToolStyle::Create()
{
	...
	Style->Set("MinesweeperTool.OpenPluginWindow", new IMAGE_BRUSH(TEXT("ButtonIcon_40x"), Icon40x40));
